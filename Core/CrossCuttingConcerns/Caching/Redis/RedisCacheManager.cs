	...
	public class RedisCacheManager : ICacheManager
	{
		...
		public IEnumerable<string> GetAllKeys()
		{
			...
			try
			{
				...
				keys.AddRange(redisKeys.Select(key => key.ToString()));
			}
			catch (Exception ex)
			{
				System.Diagnostics.Debug.WriteLine($"Error in GetAllKeys: {ex.Message}");
			}
			return keys;
		}
		...
		public void Clear()
		{
			...
			{
				System.Diagnostics.Debug.WriteLine($"Error in Clear: {ex.Message}");
			}
		}
